...
import ptystudybuddy.psb.annotations.student.exists.email.StudentEmailExistsValidator
import ptystudybuddy.psb.annotations.student.exists.socialId.StudentSocialIdExistsValidator
...
data class StudentRegisterReq(
  ...
  @field:StudentSocialIdExistsValidator
  val socialId: String,
  @field:Email(
    regexp = "^[a-zA-Z0-9._%+\\-]+@(?!ptystudybuddy\\.dev)[a-zA-Z0-9.\\-]+\\.[a-zA-Z]{2,}$",
    message = "Ingrese un correo electrónico válido",
  )
  @field:StudentEmailExistsValidator
  val email: String,
  @field:Pattern(
    regexp = "^(?=.*[a-zA-Z])(?=.*\\d)(?=.*[@#$¡*]).{9,}$",
    message =
