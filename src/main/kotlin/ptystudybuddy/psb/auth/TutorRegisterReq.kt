...
import ptystudybuddy.psb.annotations.files.pdf.PDFValidator
import ptystudybuddy.psb.annotations.tutors.exists.email.TutorEmailExistsValidator
import ptystudybuddy.psb.annotations.tutors.exists.socialId.TutorSocialIdExistsValidator

data class TutorRegisterReq(
  ...
  @field:TutorSocialIdExistsValidator
  val socialId: String,
  @field:Email(
    regexp = "^[a-zA-Z0-9._%+\\-]+@(?!ptystudybuddy\\.dev)[a-zA-Z0-9.\\-]+\\.[a-zA-Z]{2,}$",
    message = "Ingrese un correo electrónico válido",
  )
  @field:TutorEmailExistsValidator
  val email: String,
  @field:Pattern(
    regexp = "^(?=.*[a-zA-Z])(?=.*\\d)(?=.*[@#$¡*]).{9,}$",
    message =
  ...
  @field:PDFValidator val cv: MultipartFile,
)
